    ...
    render: function(){
        return (
            <div className="howTo">
                ...
                medon-lab.com/keisanki/?id=数字 の形のURLにアクセスすることで、いつでもデータを読み出せるようになります。</p>
                <p>上記の各タブの入力例をそのまま保存したものが<a href="https://medon-lab.com/keisanki/?id=1101">こちら</a>です。ご参考になれば幸いです。</p>
    ...
    render: function() {
        return (
            <div className="howTo">
                ...
                <p>例えばの<a href="https://medon-lab.com/keisanki/?id=748">編成例</a>ですが、下記画像のように</p>
